...
def get_figure_save_path(filename: str) -> str:
    """
    図の保存先（figs_&_movies ディレクトリ内のファイルパス）を返す。
    """
...
def plot_3d_movie_trajectories(trajectories: np.ndarray, constants: dict) -> None:
    import matplotlib.pyplot as plt
    from mpl_toolkits.mplot3d import Axes3D
    from tools.plot_utils import draw_egg_3d, draw_medium
